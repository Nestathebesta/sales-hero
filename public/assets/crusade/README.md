...
| `../../../art-src/crusader-spritesheet.png` | **Source reference art** (2048×2048) — labeled with titles + "F1..F4" and a flat gray background. Lives in `art-src/` (repo root) so it is **not** shipped to `dist/`; it is only the build-time input to the generator. |
